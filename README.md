...
## 🏗️ System Architecture and The "Whys"
...
3. ⚙️ **CI/CD Automation (GitHub Actions):** A YAML-based workflow that listens for code pushes to the main branch. 
